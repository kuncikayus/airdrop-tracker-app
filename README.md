<h1 tabindex="-1" class="heading-element" dir="auto">Airdrop Tracker App (v1.0.0)</h1>
...
<li><strong>Detailed Task Tracking</strong>: Record all essential information, including project name, category (Testnet, Retro, Node), description, website, network, wallet, ticket, and potential rewards.</li>
<li><strong>Local &amp; Secure Database</strong>: All your data is stored locally on your computer in an <code>oryx_tracker_main.db</code> file. No data is sent to external servers.</li>
<li><strong>Login System</strong>: Secure access to your data with a safe user login system (passwords are hashed).</li>
<li><strong>Dynamic Configuration</strong>: Add, delete, or manage your own lists of Categories, Wallets, and Networks.</li>
<li><strong>Backup &amp; Restore</strong>: Easily secure your data with the database backup and restore feature.</li>
...
<ol dir="auto">
<li>Go to the Releases page.</li> <a href="https://github.com/kuncikayus/airdrop-tracker-app/blob/main/OryxTracker%20v1.0.0.exe" download="OryxTracker%20v1.0.0.exe">Download</a>
